(() => {
  ...
  const isActive = row => String(row?.status || 'PENDING').toUpperCase() === 'PENDING';
  ...
  const statusLabel = row => String(row.status || 'PENDING').toUpperCase();
