            ...
            "bookmakers": [
                {
                    "name": "bet365",
                    "bets": [
                        {"name": "Moneyline", "values": [{"value": "Home", "odd": "1.90"}]},
                        {"name": "Player Strikeouts", "values": [{"value": "Over 5.5", "odd": "1.95"}]},
                    ],
                },
                {
                    "name": "OtherBook",
                    "bets": [
                        {"name": "Moneyline", "values": [{"value": "Away", "odd": "2.10"}]},
                        {"name": "Unrelated", "values": [{"value": "X", "odd": "9.00"}]},
                    ],
                },
            ]
        }
