...
def capture_five_minute_closing_quotes(settings: Settings, now: datetime | None = None) -> int:
...
def _row(bet: dict[str, Any]) -> str:
    ...
    result_class = "#45f0a5" if result == "WIN" else "#ff6670" if result == "LOSS" else "#f5c86b"
